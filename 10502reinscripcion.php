...
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(190, 5,utf8_decode('10502                                   Inscripción / Reinscripción                                            1                          $300                                                          $300'), 0, 0, '',1);
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(110, 5, ': 45818404297531100237 ', 0, 0, '');
$pdf->Image('img/300.jpeg', 160, 120, 30, 12);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(1, 5, '(TRECIENTOS PESOS MEXICANOS)', 0, 0, '');
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(110, 5, ': 45818404297531100237 ', 0, 0, '');
$pdf->Image('img/300.jpeg', 160, 255, 30, 12);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(1, 5, '(TRECIENTOS PESOS MEXICANOS)', 0, 0, '');
