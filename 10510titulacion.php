...
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(190, 5,utf8_decode('10510                                         Derecho a titulación                                              1                           $5000                                                        $5000'), 0, 0, '',1);
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(114, 5, ': 45818404297531100237 ', 0, 0, '');
$pdf->Image('img/5000.jpeg', 160, 120, 30, 12);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(1, 5, '(CINCO MIL PESOS MEXICANOS)', 0, 0, '');
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(114, 5, ': 45818404297531100237 ', 0, 0, '');
$pdf->Image('img/5000.jpeg', 160, 255, 30, 12);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(1, 5, '(CINCO MIL PESOS MEXICANOS)', 0, 0, '');
