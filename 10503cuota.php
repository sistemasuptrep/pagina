...
$pdf->SetTextColor(0, 0, 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(190, 5,utf8_decode('10503                                        Cuota Cuatrimestral                                               1                           $1300                                                        $1300'), 0, 0, '',1);
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(105, 5, ': 45818404297531100237 ', 0, 0, '');
$pdf->Image('img/1300.jpeg', 160, 120, 30, 12);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(1, 5, '(MIL TRECIENTOS PESOS MEXICANOS)', 0, 0, '');
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(105, 5, ': 45818404297531100237 ', 0, 0, '');
$pdf->Image('img/1300.jpeg', 160, 255, 30, 12);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(1, 5, '(MIL TRECIENTOS PESOS MEXICANOS)', 0, 0, '');
